$(function(){
    ...
    function carregaDinamico() {
        $('[pagina]').click(function(){ // pega o meu atributo criado para os links
            ...
            $('.container-principal').load(pagina+'.php'); // carrega a mina página de notícia no lugar da página principal
